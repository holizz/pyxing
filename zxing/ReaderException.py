...
class ReaderException(Exception):
    ...
    busy = False
    def __init__(self):
        if ReaderException.instance is None and not ReaderException.busy:
            ReaderException.busy = True
            ReaderException.instance = ReaderException()

    class Callable:
        def __init__(self, f):
            self.__call__ = f
    getInstance = Callable(lambda: ReaderException.instance if ReaderException.instance else ReaderException())
